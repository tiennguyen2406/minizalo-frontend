        ...
        return (
            <View style={{ flex: 1, padding: 24, backgroundColor: "#f2f4f7" }}>
                ...
                <Text style={{ marginTop: 8, color: "#666" }}>
                    Trang khám phá - đang phát triển.
                </Text>
            </View>
        );
    }
            ...
            <SafeAreaView style={{ backgroundColor: colors.headerBg }} edges={["top"]}>
                ...
                >
                    ...
                    <TouchableOpacity style={{ padding: 4 }} activeOpacity={0.8}>
                        <Ionicons name="qr-code-outline" size={24} color={colors.headerIcon} />
                    </TouchableOpacity>
                </View>
            </SafeAreaView>

            <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 20 }}>
                <Ionicons name="grid-outline" size={64} color={colors.textSecondary} style={{ marginBottom: 16 }} />
                <Text style={{ fontSize: 18, fontWeight: "600", color: colors.text }}>Khám phá</Text>
